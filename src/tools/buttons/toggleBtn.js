      ...
      props.type === 'type'?
        ...
        :props.type === 'callType'?
          <ToggleButtonGroup
              ...
              aria-label="Platform"
            >
              <ToggleButton className={Style.toggleBtn}  value="sales">Sale</ToggleButton>
              <ToggleButton className={Style.toggleBtn}  value="requestFollowUp">Follow up request</ToggleButton>
              <ToggleButton className={Style.toggleBtn}  value="invoiceFollowUp">Invoice tracking</ToggleButton>
              <ToggleButton className={Style.toggleBtn}  value="customerSatisfaction">Customer satisfaction</ToggleButton>
          </ToggleButtonGroup>
          ...
          <ToggleButtonGroup
              ...
              aria-label="Platform"
            >
              <ToggleButton className={Style.toggleBtn}  value={true}>Answered</ToggleButton>
              <ToggleButton className={Style.toggleBtn}  value={false}>No answer</ToggleButton>        
          </ToggleButtonGroup>     
        :props.type === 'prInfos'?
          <ToggleButtonGroup  
              color="primary"
