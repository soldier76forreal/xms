...
import Style from "../../components/fileManager/fileMain.module.scss"; 
...
import DocViewerBox from "../../components/fileManager/docViewer";
import moment from 'jalali-moment'
import ShareTheLink from "../../components/fileManager/shareTheLink";
...
import SpeedDialForResponsiveUpload from "../../components/fileManager/speedDialForResponsiveUpload";
   ...
   useEffect(() => {
    ...
    return(
        <Fragment>
            ...
            <div style={{height:'100%', maxHeight:'100%',padding:'10px'}} className={Style.innerScroll}>
                <div style={{width:'100%'}} id="gallery--getting-started" >
                    
                    {props.filesToShow.length ===0?
                        <div style={{padding:'50px 0px 50px 0px',display:'flex',justifyContent:'center',alignItems:'center'}}>
                            Gallery is empty
                        </div>
                    :
                        <Grid   columns={{ xs: 4, sm: 6, md: 8 , lg:12  }} sx={{ flexGrow: 1 }} rowSpacing={1} container spacing={1} item>
                            {props.filesToShow.map((e  , i)=>{
                                if(e.file !== undefined){
                                                ...
                                                <div   className='imageDivForFileFolder'>
                                                    <div style={{height:'fit-container'}}>
                                                        ...
                                                        {/* <div className={Style.fileIconDiv}>
                                                            ...
                                                            <a className={Style.linkImg} style={{textAlign:'center',display:'flex',justifyContent:'center'}}  href={`${axiosGlobal.defaultTargetApi}/uploads/${e.file.metaData.filename}`} 
                                                                data-pswp-width={e.dim.width} 
                                                                data-pswp-height={e.dim.height} 
                                                                target="_blank">
                                                                <img style={{margin:'0px auto 0px auto',textAlign:'center',maxWidth:'130px'}} src={`${axiosGlobal.defaultTargetApi}/uploads/${e.file.metaData.filename}`} className='galleryImgForFileFolder'></img>
                                                            </a>
                                                        <div style={{padding:'5px 0px 0px 0px',textAlign:'center'}} className='fileNameForFileFolder'>{truncateString(e.file.metaData.originalname,30)}</div>
                                                        <div className='subToolSectionForFileFolder'>
                                                            <div className={Style.menuNormal} style={{float:'right' , display:'block'}}>
                                                                <IconButton
                                                                    aria-label="more"
                                                                    id="long-button"
                                    ...
                                    return(
                                        <Grid md={4} item xs={2} key={i} >
                                            <div   className='imageDivForFileFolder'>
                                                    <FileIcon  extension={e.file.format} {...defaultStyles[e.file.format]} />

                                                {/* <img src={FlagPlaceholder} className={Style.galleryImg}></img> */}
                                                <div style={{padding:'5px 0px 0px 0px',textAlign:'center'}}  className={Style.fileName}>{truncateString(e.file.metaData.originalname,30)}</div>
                                                <div className={Style.subToolSection}>
                                                    <div className={Style.menuNormal} style={{ float:'right', display:'block'}}>
                                                        <IconButton
                                                            aria-label="more"
