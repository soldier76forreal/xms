...
export default function CustomSelect(props) {
  ...
  const IconOption = props => (
    <Option style={{textAlign:'left'}} {...props}>
        {props.data.name}
        <i className={`${(props.data.code).toLowerCase()} flag`}></i>
    </Option>
  );
    
  const IconOptionWithCountryCode = props => (
    <Option style={{textAlign:'left'}} {...props}>
        {props.data.name + '('+props.data.phone+')'}
        <i className={`${(props.data.code).toLowerCase()} flag`}></i>
    </Option>
  );
  const IconOptionWithCommunicated  = props => (
    <Option style={{textAlign:'left'}} {...props}>
        {props.data.icon}
  ...
  return (
    <div style={{zIndex:'1000'}}>
      ...
      :props.selectType === 'countryWithFlag' ?
        <Select
          defaultValue={selectedOption}
          // onChange={(e)=>{props.onChange(e.code)}}
          onChange={props.onChange}
          name={props.name}
          options={countries}
          styles={colorStyles}
      ...
      :props.selectType === 'platformsWithIcon' ?
          <Select
            ...
            value={platformWithIcon.filter(e=>{return e.id === props.value})[0]}
            styles={colorStyles}
            isDisabled={props.disable === true ? true : false}
      ...
      :props.selectType === 'platformChannels' ?
            ...
            value= {props.platformChannels.filter(e=>{return JSON.stringify(e.text) === JSON.stringify(props.value)})[0]}
            styles={colorStyles}
            theme={theme}
      ...
      :props.selectType === 'customerOrigin' ?
          ...
          :props.selectType === 'customerType' ?
            ...
            <Select
              ...
              value= {orderType.filter(e=>{return e.id === props.value})[0]}
              styles={colorStyles}
              theme={theme}
          ...
          :props.selectType === 'customers' ?
              ...
              <Select
                ...
                value= {props.options.filter(e=>{return e.id === props.value})[0]}
                styles={colorStyles}
                theme={theme}
          ...
          :props.selectType === 'UOM' ?
            <Select
              ...
              name={props.name}
              options={uom} 
              value= {uom.filter(e=>{return e.id === props.value})[0]}
              styles={colorStyles}
              theme={theme}
          ...
          :props.selectType === 'invoiceStatus' ?
            ...
            <Select
              ...
              value= {customerType.filter(e=>{return e.id === props.value})[0]}
              styles={colorStyles}
              theme={theme}
          ...
          :props.selectType === 'personOrCompany' ?
            <Select
              ...
              value={companyOrPerson.filter(e=>{return e.id === props.value})[0]}
              getOptionLabel={option => option.text}
              getOptionValue={option => option.id}
              placeholder={props.placeholder}
            ></Select>
...
var platformWithIcon = [
  {id:'call' , text:'Phone call' , icon:<Call></Call>},
  {id:'web' , text:'Website' , icon:<Web></Web>},
  {id:'in' , text:'Instagram' , icon:<Instagram></Instagram>},
  {id:'li' , text:'Linked In' , icon:<LinkedIn></LinkedIn>},
  {id:'wa' , text:'WhatsApp' , icon:<WhatsApp></WhatsApp>},
  {id:'fa' , text:'Facebook' , icon:<Facebook></Facebook>},
  {id:'bt' , text:'Botim' , icon:<Facebook></Facebook>},
  {id:'em' , text:'Email' , icon:<Email> </Email>}
]
