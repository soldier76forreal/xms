...
export default function CustomSelect(props) {
  ...
  const IconOption = (optProps) => (
    <Option style={{ textAlign: 'left' }} {...optProps}>
      {optProps.data.name}
      <i className={`${(optProps.data.code).toLowerCase()} flag`} />
    </Option>
  );

  const IconOptionWithCountryCode = (optProps) => (
    <Option style={{ textAlign: 'left' }} {...optProps}>
      {optProps.data.name + ' (' + optProps.data.phone + ')'}
      <i className={`${(optProps.data.code).toLowerCase()} flag`} />
    </Option>
  );

  const IconOptionWithCommunicated = (optProps) => (
    <Option style={{ textAlign: 'left' }} {...optProps}>
      {optProps.data.icon}
      <span style={{ marginTop: '4px', marginLeft: '5px' }}>{optProps.data.text}</span>
    </Option>
  );
    ...
    <div style={{ zIndex: 1000 }}>
      {props.selectType === 'personTitle' ? (
        <Select
          ...
          isDisabled={props.disable === true}
          name={props.name}
          options={prTitles}
          value={prTitles.filter((e) => e.id === props.value)[0]}
          styles={colorStyles}
          theme={selectTheme}
        ...
        />
      ) : props.selectType === 'countryWithFlag' ? (
        <Select
          defaultValue={selectedOption}
          onChange={props.onChange}
          name={props.name}
          ...
          styles={colorStyles}
          theme={selectTheme}
          value={countries.filter((e) => e.code === props.value || e.phone === props.value)[0]}
          ...
          placeholder={props.placeholder}
        />
      ) : props.selectType === 'platformsWithIcon' ? (
        <Select
          defaultValue={selectedOption}
          onChange={props.onChange}
          name={props.name}
          options={platformWithIcon}
          theme={selectTheme}
          value={platformWithIcon.filter((e) => e.id === props.value)[0]}
          styles={colorStyles}
          isDisabled={props.disable === true}
          components={{ Option: IconOptionWithCommunicated }}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
          placeholder={props.placeholder}
        />
      ) : props.selectType === 'countryWithFlagAndCountryCode' ? (
        <Select
          defaultValue={selectedOption}
          onChange={props.onChange}
          name={props.name}
          options={countries}
          theme={selectTheme}
          value={countries.filter((e) => parseInt(e.phone) === parseInt(props.value))[0]}
          styles={colorStyles}
          isDisabled={props.disable === true}
          ...
          placeholder={props.placeholder}
        />
      ) : props.selectType === 'platformChannels' ? (
        <Select
          defaultValue={selectedOption}
          onChange={props.onChange}
          isDisabled={props.disable === true}
          name={props.name}
          options={props.platformChannels}
          value={props.platformChannels.filter((e) => JSON.stringify(e.text) === JSON.stringify(props.value))[0]}
          styles={colorStyles}
          theme={selectTheme}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
          placeholder={props.placeholder}
        />
      ) : props.selectType === 'customerOrigin' ? (
        <Select
          defaultValue={selectedOption}
          name={props.name}
          onChange={props.onChange}
          ...
          styles={colorStyles}
          theme={selectTheme}
          value={customerOrigin.filter((e) => e.id === props.value)[0]}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
          placeholder={props.placeholder}
        />
      ) : props.selectType === 'customerType' ? (
        <Select
          defaultValue={selectedOption}
          onChange={props.onChange}
          isDisabled={props.disable === true}
          ...
          value={customerType.filter((e) => e.id === props.value)[0]}
          styles={colorStyles}
          theme={selectTheme}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
        ...
        <Select
          ...
          value={props.options.filter((e) => e.id === props.value)[0]}
          styles={colorStyles}
          theme={selectTheme}
          getOptionLabel={(o) => o.name}
          getOptionValue={(o) => o.id}
        ...
        <Select
          ...
          name={props.name}
          options={uom}
          value={uom.filter((e) => e.id === props.value)[0]}
          styles={colorStyles}
          theme={selectTheme}
          getOptionLabel={(o) => o.name}
          getOptionValue={(o) => o.id}
        ...
        <Select
          ...
          name={props.name}
          options={orderType}
          value={orderType.filter((e) => e.id === props.value)[0]}
          styles={colorStyles}
          theme={selectTheme}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
          placeholder={props.placeholder}
        />
      ) : props.selectType === 'invoiceStatus' ? (
        <Select
          defaultValue={selectedOption}
          onChange={props.onChange}
          isDisabled={props.disable === true}
          ...
          value={invoiceStatus.filter((e) => e.id === props.value)[0]}
          styles={colorStyles}
          theme={selectTheme}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
          placeholder={props.placeholder}
        />
      ) : props.selectType === 'personOrCompany' ? (
        <Select
          defaultValue={selectedOption}
          name={props.name}
          onChange={props.onChange}
          isDisabled={props.disable === true}
          options={companyOrPerson}
          styles={colorStyles}
          theme={selectTheme}
          value={companyOrPerson.filter((e) => e.id === props.value)[0]}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
          placeholder={props.placeholder}
        />
        ...
        <Select
          ...
          styles={colorStyles}
          theme={selectTheme}
          value={props.options.filter((e) => e.value === props.value)[0]}
          getOptionLabel={(o) => o.name}
        ...
        <Select
          ...
          styles={colorStyles}
          theme={selectTheme}
          value={requestType.filter((e) => e.id === props.value)[0]}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
          placeholder={props.placeholder}
        />
        ...
        <Select
          ...
          styles={colorStyles}
          theme={selectTheme}
          value={contactList.allAll.map((e) => ({ id: e._id, text: `${e.firstName} ${e.lastName}` })).filter((e) => e.id === props.value)[0]}
          getOptionLabel={(o) => o.text}
          getOptionValue={(o) => o.id}
          placeholder={props.placeholder}
        />
...
const platformWithIcon = [
  { id: 'call', text: 'Phone call', icon: <Call /> },
  { id: 'web', text: 'Website', icon: <Web /> },
  { id: 'in', text: 'Instagram', icon: <Instagram /> },
  { id: 'li', text: 'Linked In', icon: <LinkedIn /> },
  { id: 'wa', text: 'WhatsApp', icon: <WhatsApp /> },
  { id: 'fa', text: 'Facebook', icon: <Facebook /> },
  { id: 'bt', text: 'Botim', icon: <Facebook /> },
  { id: 'em', text: 'Email', icon: <Email /> },
];
...
const invoiceStatus = [
  { id: 'in', text: 'Initializing' },
  { id: 'pr', text: 'In process' },
  { id: 'fi', text: 'Finished' },
];
...
const orderType = [
  { id: 'bc', text: 'Business card' },
  { id: 'nbc', text: 'NFC Business card' },
  { id: 'fl', text: 'Flyer' },
  { id: 'sta', text: 'Standee' },
  { id: 'vpi', text: 'Vinyl' },
  { id: 'ofs', text: 'Office set' },
  { id: 'tm', text: 'Table mat' },
  { id: 'cm', text: 'Car mat' },
  { id: 'dh', text: 'Door hanger' },
  { id: 'ru', text: 'Roll up' },
  { id: 'pc2', text: 'Paper cups' },
  { id: 'fb', text: 'Fastfood boxes' },
  { id: 'pb', text: 'Paper bag' },
  { id: 'cp', text: 'Custom product' },
  { id: 'pla', text: 'Plaques' },
  { id: 'dw', text: 'Drink wares' },
  { id: 'tg', text: 'Tech gifts' },
  { id: 'cus', text: 'Custom pen' },
  { id: 'sci', text: 'School items' },
  { id: 'bg', text: 'Bags' },
  { id: 'si', text: 'Sinage' },
  { id: 'ep', text: 'Event planning' },
  { id: 'hc', text: 'Handy craft' },
  { id: 'sti', text: 'Sticker' },
  { id: 'bro', text: 'Brochure' },
];
...
const countries = [
  ...
  { name: 'Korea, Democratic Republic', code: 'KP', phone: 850 },
