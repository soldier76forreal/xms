...
const CrmPortal = (props) =>{
    ...
    return(
        <Fragment>
            ...
            <NewCall  successToast={successToast} setSuccessToast={setSuccessToast}   ></NewCall>
            <OpenIconSpeedDial  onClick={()=>{dispatch(actions.toggleNewCustomer()); history.push('#newCustomer')}}></OpenIconSpeedDial>
            ...
            <CallModal   setOpenCallModal={setOpenCallModal} openCallModal={openCallModal}></CallModal>
            <div style={{maxWidth:'1500px' , height:'98vh' , padding:'0px 5px 0px 5px'}}  className={Style.ovDiv}>
                ...
                {customerToShow.length === 0 && crmLoading.loading === false && crmLoading.retry === false?
                    <div style={{height:'70vh' , display:'flex' , justifyContent:'center' , alignItems:'center'}}>
                        <NoData caption='There is no customer...'></NoData>
                    </div>
                :customerToShow.length > 0 && crmLoading.loading === false && crmLoading.retry === false? 
                                        ...
                                        if(data !==undefined){
                                            return(
                                                <Col style={{padding:'5px'}} xs={12} sm={6} md={6} lg={4} xl={3} xxl={3}>
                                                    {
                                                    tileCompress=== false?
                                                        <PersoneCard   setShowCustomer={setShowCustomer} showCustomer={showCustomer} editCustomer={editCustomer} setEditCustomer={setEditCustomer} setOpenCallModal={setOpenCallModal} setWhatsAppMsgList={setWhatsAppMsgList} setOpenWhatsAppModal={setOpenWhatsAppModal} deleteModal={deleteModal}  data={data} key={i} ></PersoneCard>   
                                                    :tileCompress===true?
                                                        <PersoneCardMinimized  setShowCustomer={setShowCustomer} showCustomer={showCustomer} editCustomer={editCustomer} setEditCustomer={setEditCustomer} setOpenCallModal={setOpenCallModal} setWhatsAppMsgList={setWhatsAppMsgList} setOpenWhatsAppModal={setOpenWhatsAppModal} deleteModal={deleteModal}  data={data} key={i} ></PersoneCardMinimized>
                                                    :null
                                                    }   
                                                </Col>
                                            )
                                        ...
                                        if(data !==undefined){
                                            return(
                                                <Col style={{padding:'5px'}} xs={12} sm={6} md={6} lg={4} xl={3} xxl={3}>
                                                    {
                                                    tileCompress=== false?
                                                        <PersoneCard   setShowCustomer={setShowCustomer} showCustomer={showCustomer} editCustomer={editCustomer} setEditCustomer={setEditCustomer} setOpenCallModal={setOpenCallModal} setWhatsAppMsgList={setWhatsAppMsgList} setOpenWhatsAppModal={setOpenWhatsAppModal} deleteModal={deleteModal}  data={data.item} key={i} ></PersoneCard>   
                                                    :tileCompress===true?
                                                        <PersoneCardMinimized  setShowCustomer={setShowCustomer} showCustomer={showCustomer} editCustomer={editCustomer} setEditCustomer={setEditCustomer} setOpenCallModal={setOpenCallModal} setWhatsAppMsgList={setWhatsAppMsgList} setOpenWhatsAppModal={setOpenWhatsAppModal} deleteModal={deleteModal}  data={data.item} key={i} ></PersoneCardMinimized>
                                                    :null
                                                    }   
                                                </Col>
                                            )
