...
const Users = (props) =>{
    ...
    return(
        <Fragment>
            ...
            <MainNav></MainNav>
            <UserEdit setRefresh={setContectRefresh}  openEditUser={openEditUser} setOpenEditUser={setOpenEditUser}   setSuccessToast={setSuccessToast} setTargetedEditData={setTargetedEditData}   targetedEditData={targetedEditData}></UserEdit>
            ...
            <div className={Style.usersDiv}>
                <div className={Style.topSection}>
                    ...
                    <div  className={Style.topTitle}>Users</div>
                </div>
